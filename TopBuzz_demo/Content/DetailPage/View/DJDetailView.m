...
- (instancetype)initWithFrame:(CGRect)frame itemInfo:(DJCollectionItemInfo *)itemInfo {
    ...
    if (self) {
        ...
        _commentView_Y = VIEW_Y(_text) + VIEW_HEIGHT(_text) + 60;
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context {
    if ([keyPath isEqualToString:@"commentItemInfoArray"]) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            [strongSelf setContentSize:CGSizeMake(0, VIEW_Y(strongSelf.commentView) + VIEW_HEIGHT(strongSelf.commentView) + 20)];
...
- (void)loadStatuView {
    ...
    [repostCount setText:_itemInfo.repostCount];
    ...
    [commentCount setText:_itemInfo.repostCount];
    ...
    [likeCount setText:_itemInfo.repostCount];
