...
+ (DJCollectionItemInfo *)getCollectionItemInfoFromSourceData:(SourceDataItemInfo *)sourceData{
    ...
    itemInfo.thumbnailImageString = sourceData.thumbnail_pic.urlString;
    itemInfo.bmiddleImageString = sourceData.bmiddle_pic.urlString;
    itemInfo.originalImageString = sourceData.original_pic.urlString;
