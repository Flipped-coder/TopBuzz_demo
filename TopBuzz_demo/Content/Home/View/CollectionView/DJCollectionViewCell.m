...
- (void)layoutCollectionViewCellWithData:(DJCollectionItemInfo *)itemInfo {
    ...
    if (!itemInfo.thumbnailImage) {
        [itemInfo addObserver:self forKeyPath:@"thumbnailImage" options:NSKeyValueObservingOptionNew context:nil];
    } else {
        self.imageView.image = itemInfo.thumbnailImage;
    }
    ...
    if (!itemInfo.profileImage) {
        [itemInfo addObserver:self forKeyPath:@"profileImage" options:NSKeyValueObservingOptionNew context:nil];
    } else {
        self.profileImageView.image = itemInfo.profileImage;
    }
